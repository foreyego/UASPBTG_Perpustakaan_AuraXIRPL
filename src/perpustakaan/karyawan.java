...
gaji.setText("0");
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/database_perpustakaan", "root", "");
            String sql="update karyawan set NIK=?,Nama=?,Jenis_Kelamin=?,Golongan=?,Jabatan=?,Absen=?, Jumlah_Absen=?,Biaya_Transport=?,Tunjangan=?,Gaji=? where "+"NIK='"+nik.getText()+"'";
            ...
            if(coba==0) {
                try {
                    ...
                    st.setString(4,gol.getText());
                    st.setString(5,jab.getText());
