...
Object kolom []={"NIM", "Nama","Kode_Buku", "Nama_Buku", "Tanggal_Pinjam", "Tanggal_Kembali"};
...
String tglp=res.getString("Tanggal_Peminjaman");
String tglk=res.getString("Tanggal_Pengembalian");
Object [] data={Nim,Nama,Kode,Nabuk,tglp,tglk};
...
JOptionPane.showMessageDialog(this, "Error: "+ex);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try {
            ...
            if (res.next()) {
                ...
                namabuku.setText(res.getString(3));
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/database_perpustakaan", "root", "");
            String sql="update peminjam set NIM=?,Nama=?,Kode_Buku=?,Nama_Buku=?, Tanggal_Peminjaman=?,Tanggal_Pengembalian=? where "+"NIM='"+nim.getText()+"'";
            PreparedStatement st=conn.prepareStatement(sql);
            if(coba==0) {
                try {
                    st.setString(1,nim.getText());
                    st.setString(2,nama.getText());
                    st.setString(3,namabuku.getText());
    ...
    private void nimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nimActionPerformed
        ...
        try {
            ...
            if (res.next()) {
                ...
                nim.setText(res.getString(1));
                nama.setText(res.getString(2));
                kodebuku.setText(res.getString(3));
